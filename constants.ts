...
export const MOCK_TOKENS_INIT: Token[] = [
  { id: 'mon', symbol: 'MON', name: 'Monad', price: 12.50, change24h: 5.4, marketCap: 2000000000, volume24h: 50000000, category: 'Layer 1', dominance: 50, chainId: 'monad' },
  ...
  { id: 'stmon', symbol: 'stMON', name: 'Staked Monad', price: 12.80, change24h: 5.6, marketCap: 20000000, volume24h: 1000000, category: 'DeFi', dominance: 2, chainId: 'monad' },
